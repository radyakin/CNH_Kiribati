...
# FIX IT - note: some short answers are still included in the single plots because they don't look too bad (e.g., "Year sewerage channel was introduced", Fee for connecting to sewage system); fill-in response questions are ID'ed based on eyeballing final plots
...
vrs_islands <- vrsTidy %>%
  select(interview__key, interview__id, vrs_island) %>%
  unique()
