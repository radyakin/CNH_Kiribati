...
# Clean market data
#___________________________________________________________________________________________#
market.files <- list.files(file.path(datadir, "Market Survey"))
...
food.roster <- read_dta(file.path(datadir, "Market Survey", 
                                    paste(food.files[1], "roster.dta", sep ="_")))
unit.roster <- read_dta(file.path(datadir, "Market Survey", 
...
survey.info <- read_dta(file.path(datadir, "Market Survey", "MarketSurvey.dta"))
